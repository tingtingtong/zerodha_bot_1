# ZerodhaBot - Paper Trading Startup Script (PowerShell)
# Run this on trading days (Mon-Fri, 9:00-16:00 IST)
...
Write-Host "  ZerodhaBot - Paper Trading Mode" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "    Dashboard started. Open http://localhost:8501 in your browser." -ForegroundColor Green
Write-Host ""

# -- Step 3: Start bot --------------------------------------------------------
Write-Host "[3] Starting bot in PAPER mode..." -ForegroundColor Yellow
